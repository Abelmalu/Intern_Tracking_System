        ...
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            @if ($user->information)
                                ...
                                @if (
                                    $user->information->application_letter_file_path ||
                ...
                <div class="col-md-12 mb-3">
                        <a onclick="if(confirm('Are you sure, you want to reject this Application?') == false){event.preventDefault()}" href="{{ route('department.application.reject', $application) }}" class="btn btn-danger">Reject Application</a>
                        <a onclick="if(confirm('Are you sure, you want to accept this Application?') == false){event.preventDefault()}" href="{{ route('department.application.accept', $application) }}" class="btn btn-success float-right">Accept Application</a>
                    </div>
                {{-- @else
                <div class="col-md-12 mb-3">
                        <a onclick="if(confirm('Are you sure, you want to reset this Application status?') == false){event.preventDefault()}" href="{{ route('department.application.reset', $application->id) }}" class="btn btn-warning float-right">Reset Application Status</a>
                    </div> --}}
                @endif
            </div>
            ...
            <div class="col-md-3">
                {{-- @if ($interview)
                    <a target="_balnk" href="" class="btn btn-info btn-block mb-3">Message</a>
                    {{-- @else --}}
