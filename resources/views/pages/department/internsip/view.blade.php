            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('internship.index') }}">List</a></li>
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <div class="card-tools mr-5">
                                <a href="{{ route('internship.index') }}"><button type="button"
                                        class="btn btn-tool"><i class="fas fa-arrow-left"></i>
                                        Back
                                    </button></a>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <dl class="row">
                                        ...
                                        @foreach ($internship->programs as $program)
                                            <dd class="col-sm-3">{{ $program->name }}</dd>
                                        @endforeach
                                    </dl>
                                </div>
